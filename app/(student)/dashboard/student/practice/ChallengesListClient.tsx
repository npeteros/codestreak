...
import {
  listPracticeChallengesPage,
  type PracticeChallengeSummary,
} from "@/lib/actions/practiceChallenges";
...
interface Props {
  courseId: string;
  initialItems: PracticeChallengeSummary[];
...
export function ChallengesListClient({
  ...
  function fetchPage(
    ...
    startTransition(async () => {
      const res = await listPracticeChallengesPage(courseId, {
